...
| [limbus-autoluxer](https://github.com/Fatomartyr/limbus-autoluxer) | 6 个月前 | — | Luxcavation 自动化小工具。（观察项：仓库较小，需运行证据。） |
...
| [LZCR Limbus Zh-TW Converter](https://github.com/sipdetect/LZCR-Limbus-Zh-TW-Converter) | 2 周前 | — | 简繁/繁中本地化转换工具。（需标注：确认与 MAD/LLC 的兼容关系。） |
...
| [LCB-ID-TLs](https://github.com/NotherWael/LCB-ID-TLs) | 1 周前 | — | Identity 文本翻译资料。（需标注：与 DialogueBoxes_EN 区分用途后收录。） |
...
| [Limbus-RU-Full](https://github.com/Slavuck/Limbus-RU-Full) | 3 周前 | — | 俄语完整翻译候选。（观察项：名称宣称 Full，但需抽样和版本核验。） |
...
| [AutoLocalization](https://github.com/Cynanchum0109/AutoLocalization) | 1 天前 | — | 自动化本地化实验。（观察项：与成熟工具重叠，先观察。） |
...
| [Limbus-Multi-tool](https://github.com/CowboyBingus/Limbus-Multi-tool) | 3 个月前 | — | 面向 Limbus 的多功能开发/Mod 工具。（需标注：近期更新，但需审查具体功能。） |
...
| [limbus_data](https://github.com/monthofjune/limbus_data) | 2 个月前 | — | Limbus 数据文件集合。（需标注：候选数据源，需检查更新方法。） |
...
| [limbus-news-archive source](https://github.com/ItsMalikx/limbus-news-archive) | 2 周前 | — | 官方公告归档的源码和索引逻辑。 |
...
| [Limbus Company Resource Calculator](https://github.com/DireSpidar/Limbus-Company-Resource-Calculator) | 7 个月前 | — | 计算升级、养成和资源需求。 |
...
| [lbc-index-beeper-m5stick](https://github.com/Yumi-mp4/lbc-index-beeper-m5stick) | 3 个月前 | — | 在 M5Stick 上实现 Index Prescript 风格终端/蜂鸣器。 |
...
| [ModularCustomA / MT Custom Scripts](https://github.com/EmptyHamburger/ModularCustomA) | 4 天前 | — | Lethe 文档列出的 Modular 扩展包，增加更多脚本/自定义行为；仓库 README 仅链接外部说明。 |
...
| [LetheModHelper](https://github.com/GanFanRenA/LetheModHelper) | 1 个月前 | — | 提供异常体、Buff、人格、被动、模型等处理器/编辑器，并含 ModScanner、ScriptParser 与 EditorGenerator。（观察项：功能面很有潜力，但无 README、提交 bin/obj，工程卫生和稳定性尚不足。） |
...
| [limbus-modding-guide](https://github.com/AIGhostWriter/limbus-modding-guide) | 4 周前 | — | 涵盖 Lethe、GlitchScript、MT Custom Scripts 和 DLL 开发的教程内容。（观察项：内容量真实，但账号和项目同日生成、明确 AI 化身份且缺少社区验证；暂不进入主推荐。） |
...
| [Limbus Battle State Editor](https://github.com/AIGhostWriter/Limbus-Battle-State-Editor) | 1 周前 | — | 战斗中实时向玩家/敌方单位注入 500+ Buff 与系统 Ability，并提供 F8 UI。（观察项：源码和 README 存在，但属于直接改变战斗结果的作弊式工具，且缺乏社区验证。） |
...
| [Limbus Company 120FPS iOS Mod](https://github.com/Vastrilliant/Limbus-Company-120FPS-iOS-Mod) | 1 周前 | — | 解锁 120FPS 等 iOS 行为，提供 Objective-C 源码及侧载/预编译 IPA 路线。（需标注：源码真实且作者披露 Claude 辅助，但签名、侧载和预编译 IPA 风险很高。） |
...
| 项目 | 最近更新 | Confirm | 简介 |
| --- | --- | --- | --- |
| [BepInEx 6 IL2CPP](https://github.com/BepInEx/BepInEx) | 3 周前 | — | Lethe、声音 Mod、战斗插件和大量 C# Mod 的底层加载器。 |
