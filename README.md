...
| [Limbus Company Tools](https://github.com/eldritchtools/limbus) | 今天 | 🟢 | limbus 攻略站。但实用性不高，如果想要搞些limbus风格的东西，可以参考代码 |
...
| [eldritchtools/limbus](https://github.com/eldritchtools/limbus) | 今天 | 🟢 | Limbus Company Tools 的开源网站项目。 |
...
| [LimbusCompanyRuMTL](https://github.com/x1bViolet/LimbusCompanyRuMTL) | 5 天前 | — | 俄语机器翻译版本。（需标注：必须显著标注 MTL，不与人工本地化同级。） |
...
| [AutoLocalization](https://github.com/Cynanchum0109/AutoLocalization) | 2 天前 | — | 自动化本地化实验。（观察项：与成熟工具重叠，先观察。） |
...
| [motions](https://github.com/LEAGUE-OF-NINE/motions) | 6 天前 | — | Limbus 动作/动画相关的 Mod 或资源。（需标注：核验具体目标和数据来源。） |
...
| [Limbus Company Battle Dialog Bubble](https://github.com/Ling-sing/Limbus_Company_Battle_Dialog_Bubble) | 4 个月前 | — | 战斗对话气泡或台词展示资源。（需标注：可放语音/文本资源区。） |
...
| [ModularCustomA / MT Custom Scripts](https://github.com/EmptyHamburger/ModularCustomA) | 5 天前 | — | Lethe 文档列出的 Modular 扩展包，增加更多脚本/自定义行为；仓库 README 仅链接外部说明。 |
...
| [limbus-modding-guide](https://github.com/AIGhostWriter/limbus-modding-guide) | 1 个月前 | — | 涵盖 Lethe、GlitchScript、MT Custom Scripts 和 DLL 开发的教程内容。（观察项：内容量真实，但账号和项目同日生成、明确 AI 化身份且缺少社区验证；暂不进入主推荐。） |
