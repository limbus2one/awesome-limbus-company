...
| [Charge Grinder](https://github.com/Walpth/Charge-Grinder) | 4 天前 | 🟢 | 支持win，linux |
...
| [OpenLethe](https://github.com/LEAGUE-OF-NINE/OpenLethe) | 1 天前 | — | Lethe 服务端的 C# / ASP.NET Core 移植版，支持使用 Docker 与 PostgreSQL 自托管。 |
...
| [DivineCompany_RussianTranslationDepartment](https://github.com/Divine-Company/DivineCompany_RussianTranslationDepartment) | 4 天前 | — | 俄语本地化项目。（观察项：与其他俄语项目重叠，建议做对比表。） |
...
| [LimbusCompanyTempLoc](https://github.com/Cynanchum0109/LimbusCompanyTempLoc) | 4 天前 | — | 临时或实验性中文本地化。（观察项：与成熟 LLC 项目可能重复。） |
...
| [Limbus Battle State Editor](https://github.com/AIGhostWriter/Limbus-Battle-State-Editor) | 3 天前 | — | 战斗中实时向玩家/敌方单位注入 500+ Buff 与系统 Ability，并提供 F8 UI。（观察项：源码和 README 存在，但属于直接改变战斗结果的作弊式工具，且缺乏社区验证。） |
...
| [Limbus Company 120FPS iOS Mod](https://github.com/Vastrilliant/Limbus-Company-120FPS-iOS-Mod) | 6 天前 | — | 解锁 120FPS 等 iOS 行为，提供 Objective-C 源码及侧载/预编译 IPA 路线。（需标注：源码真实且作者披露 Claude 辅助，但签名、侧载和预编译 IPA 风险很高。） |
