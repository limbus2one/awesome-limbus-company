...
| 项目 | 最近更新 | Confirm | 简介 |
| --- | --- | --- | --- |
| [AhabAssistantLimbusCompany](https://github.com/KIYI671/AhabAssistantLimbusCompany) | 5 天前 | 🟢 | 比较活跃 |
...
| [LZCR Limbus Zh-TW Converter](https://github.com/sipdetect/LZCR-Limbus-Zh-TW-Converter) | 5 天前 | — | 简繁/繁中本地化转换工具。（需标注：确认与 MAD/LLC 的兼容关系。） |
...
| [LCB-ID-TLs](https://github.com/NotherWael/LCB-ID-TLs) | 2 天前 | — | Identity 文本翻译资料。（需标注：与 DialogueBoxes_EN 区分用途后收录。） |
...
| [limbus-news-archive source](https://github.com/ItsMalikx/limbus-news-archive) | 4 天前 | — | 官方公告归档的源码和索引逻辑。 |
