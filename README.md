...
| [Activision](https://github.com/PhaiKub/Activision) | 3 周前 | 🟢 | Charge Grinder 的反作弊版本 |
...
| 项目 | 最近更新 | Confirm | 简介 |
| --- | --- | --- | --- |
| [LocalizeLimbusCompany](https://github.com/LocalizeLimbusCompany/LocalizeLimbusCompany) | 2 周前 | 🟢 | 零协会汉化 |
...
| [Limbus Localization UI](https://github.com/x1bViolet/Limbus-Localization-UI) | 4 周前 | — | 游戏本地化编辑器 |
...
| 项目 | 最近更新 | Confirm | 简介 |
| --- | --- | --- | --- |
| [LimbusEGOGiftYoloModel](https://github.com/limbus2one/LimbusEGOGiftYoloModel) | 5 天前 | 🟢 | 生成ego gift 图；识别饰品的yolo模型 |
...
| [LimbusMetadataRecovery](https://github.com/HZBHZB1234/LimbusMetadataRecovery) | 6 天前 | — | 自动定位并恢复加密的 `global-metadata.dat`，包含解密参数提取、31 段映射求解和重建校验。 |
...
| [myosotis-server](https://github.com/yuvlian/myosotis-server) | 6 天前 | — | 原 FurinaLC；提供账号、剧情、编队和采光战斗等基础私服功能，镜牢与铁道等模式尚不支持。 |
